...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-cj-v)twa&w9z81u%&n8#v#foa5dc7o%mmd-cd(x!ff#wyvof%b')
...
INSTALLED_APPS = [
    ...
    'responsibilities.apps.ResponsibilitiesConfig',
]
...
DATABASES = {
    'default': {
        ...
        'NAME': config('DATABASE_NAME', default='farewell_db'),
        'USER': config('DATABASE_USER', default='farewell_user'),
...
# Cache Configuration - Use Redis if available, otherwise use local memory cache
if USE_REDIS and REDIS_URL:
    CACHES = {
        'default': {
