...
from users.permissions import IsOrganizerOrAdmin, IsTreasurer
...
class ResponsibilityViewSet(viewsets.ModelViewSet):
    ...
    def perform_create(self, serializer):
        """Create responsibility with current user."""
    ...
    def get_queryset(self):
        ...
        if user.role in ['organizer', 'treasurer']:
            return Responsibility.objects.all()
        # Students see only their assigned responsibilities
    ...
    def update_status(self, request, pk=None):
        ...
        responsibility.save()
        return Response(
            ResponsibilitySerializer(responsibility).data,
    ...
    def my_responsibilities(self, request):
        """Get current user's assigned responsibilities."""
    ...
    def by_status(self, request):
        """Get responsibilities grouped by status."""
    ...
    def by_priority(self, request):
        """Get responsibilities grouped by priority."""
